...
somem. Pensado p/ composite **Screen/Add** (fundo preto) — o frame de pico é o frame `peak` (alinhar
ao corte). Também exporta versão alpha (ProRes 4444) p/ overlay direto.
