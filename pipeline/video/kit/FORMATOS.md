...
YAP é formato próprio. Edição visual mínima mantém a
...
- Explicação ilustrada (intensidade de câmera/SFX): [05 EDIT_v4](references/motion-host-baseline/README.md).
  ...
  Usar quando o vídeo pedir essa intensidade, não como default do formato.
...
**Caption.** Legenda o vídeo inteiro. Hold empilhado **só no CTA**. Sem tetris/chroma. Fontes: Hetrixo ExtraBold (sans) + Alvito Nova Comp Bold
...
e ajustar ao footage. O título é elemento separado (camada própria) quando necessário.
Explicação ilustrada: as duas famílias + hold acima.
