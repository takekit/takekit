...
- **02-muse-v2 aprovado inteiro** (12/09): "pro primeiro, obra de arte". Pipeline de 8 fases + presets em
  `resolve/` é o padrão. Melhorias vêm por cima, não do zero. `status: lei`
...
- Biblioteca de SFX na taxonomia do Peu (`resolve/assets/sfx/`); Mixkit só fallback. `status: default`
